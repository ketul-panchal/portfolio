...
const publications = {
  data: [
    ...
    {
      id: "neuro-symbolic-sudoku-solver-gotham",
      name: "Gotham Distribution",
      createdAt: "Flutter, WooCommerce REST APIs",
      description: "A high-performance Flutter WooCommerce apps integrated with a WordPress website",
      url: "https://apps.apple.com/in/app/gotham-distribution/id6740434735",
    },
    {
      id: "neuro-symbolic-sudoku-solver-newengland",
      name: "New England Distribution",
      createdAt: "Flutter, WooCommerce REST APIs",
      description: "A high-performance Flutter WooCommerce apps integrated with a WordPress website",
    ...
    {
      id: "consistency-models-corier",
      name: "Courior Managment System",
      createdAt: "ASP.Net, SQL Server File Database",
      description: "User Can Easy book and track Courior and Admin can manage the Courior and track the Courior",
      url: "https://github.com/ketul-panchal/CouriorManagment",
    },
    {
      id: "consistency-models-grosery",
      name: "Grosery E-commerce Website",
      createdAt: "ASP.Net, SQL Server File Database",
      description: "User Can Easy order and Admin can manage the Grosery and other things",
      url: "https://github.com/ketul-panchal/Grosery_E-commerce",
    },
    {
      id: "consistency-models-dance",
      name: "Dance Management System",
      createdAt: "ASP.Net, SQL Server File Database",
      description: "Admin can manage the dance class and student can book the dance class",
      url: "https://github.com/ketul-panchal/DanceManagementSystem",
    },
    {
      id: "consistency-models-ccc",
      name: "Ncc Managment System",
      createdAt: "ASP.Net, SQL Server File Database",
      description: "Admin can manage the Ncc class and student information , events, and other things",
      url: "https://github.com/ketul-panchal/NccManagment",
    },
    {
      id: "consistency-models",
